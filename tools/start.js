...
async function start() {
  ...
  const { HOSTNAME, SSL_ENABLED, PORT } = process.env;
    ...
    browserSync.create().init(
      {
        ...
        https: true,
        middleware: [server],
        // https: (SSL_ENABLED === 'true'),
        // port: PORT,
        ghostMode: false,
        logPrefix: "LUNAJETS IT-LAB",
        logLevel: "debug",
        // proxy: {
        //   target: (SSL_ENABLED === 'true') ? `https://${HOSTNAME}:${PORT}` : `http://${HOSTNAME}:${PORT}`,
        //   ws: true,
        //   proxyReq: [
        //     function(proxyReq) {
