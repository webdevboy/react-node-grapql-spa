...
class PrivateJetCharterCategory extends Component {
  ...
  render() {
    ...
    const heading = {
      subtitle: {
        defaultMessage: 'Private Jet Charter Category',
        id: 'client.pjcCategory.subtitle',
        color: 'lt-blue',
      },
      title: {
    ...
    const flyToButton = {
        ...
        id: 'client.flyTo.'+post.meta.category_sfid+'.button',     
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(PrivateJetCharterCategory);
