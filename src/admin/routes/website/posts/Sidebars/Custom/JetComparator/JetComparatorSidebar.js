...
import s from "./JetComparatorSidebar.css";
...
class JetComparatorSidebar extends Component {
  state = {
    postsByPostId: [],
    loading: true
  }
      ...
      <div className={cx(s["category-select"])}>
        <div className={cx("pt-form-group", s["articles-table"])}>
          <label className="pt-label" htmlFor="ordering">
            <TooltipLabel label="Top Aircrafts" tooltip="Order of the aircraft list" />
          </label>
          {!loading ? (
...
JetComparatorSidebar.contextTypes = {
  client: PropTypes.object.isRequired,
};

export default withStyles(s)(JetComparatorSidebar);
