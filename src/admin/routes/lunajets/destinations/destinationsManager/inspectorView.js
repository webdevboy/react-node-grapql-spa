      ...
      <div>
        ...
        <div className={s["container-content"]}>
          <div className={s.info}>
            ...
            <div>
              <label>City</label><input name="first_name" value={this.state.first_name} className={s.fieldInput} type="text" placeholder="Enter first name" onChange={this.change} />
            </div>
            <div>
              <label>Country</label><input name="last_name" value={this.state.last_name} className={s.fieldInput} type="text" placeholder="Enter last name" onChange={this.change} />
            </div>
          </div>
