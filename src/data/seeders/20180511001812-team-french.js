...
const DEPTS = ['Management', 'Vente', 'Développement', 'Technologie & Marketing', 'Support'];
...
//--------------- SUPPORT TEAM 
  ...
  down: async () => {
    ...
    await Term.destroy({ where: { language_id: fr.id, slug: { $in: DEPTS.map(dept => slugify(dept)) } }, cascade: true, force: true });
  },
};
